...
CREATE TABLE IF NOT EXISTS post(
  ...
  comment_fk_id int NOT NULL REFERENCES comment (comment_id),
...
INSERT INTO post (post_id, post_title, post_description, image, category_fk_id, comment_fk_id, user_fk_id, created_at, updated_at) VALUES
